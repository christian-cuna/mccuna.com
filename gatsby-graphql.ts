...
export type FileFieldsEnum = 
  ...
  | 'childMdx___frontmatter___iconSrc'
  | 'childMdx___slug'
  | 'childMdx___body'
  | 'childMdx___excerpt'
  | 'childMdx___headings'
...
export type MdxFrontmatterFilterInput = {
  ...
  iconSrc?: Maybe<StringQueryOperatorInput>;
};
...
export type IndexQuery = { allMdx: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'description' | 'iconSrc'>>, fields?: Maybe<Pick<MdxFields, 'blogSlug'>> } }> } };
